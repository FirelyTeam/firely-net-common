...
namespace Hl7.Fhir.ElementModel
{
    public static class ElementNodeComparator
    {
        ...
        public static TreeComparisonResult IsEqualTo(this ITypedElement expected, ITypedElement actual)
        {
            ...
            if (expected.InstanceTypeD != actual.InstanceTypeD && actual.InstanceTypeD != null) 
                return TreeComparisonResult.Fail(actual.Location, $"type: was '{actual.InstanceTypeD}', expected '{expected.InstanceTypeD}'");
