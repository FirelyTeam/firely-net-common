...
namespace Hl7.Fhir.Specification.Terminology
{
    ...
    /// <summary>
    /// Subset of the FHIR terminology service (http://hl7.org/fhir/terminology-service.html) that concerns subsumption testing.
    /// </summary>
    public interface ITerminologyServiceWithSubsumption
    {
        /// <summary>
        /// Test the subsumption relationship between code/Coding A and code/Coding B given the semantics of subsumption in the underlying code system
        /// </summary>
    ...
    public interface ITerminologyService : ICodeSystemTerminologyService, IMappingTerminologyService, ITerminologyServiceWithSubsumption, IExpandingTerminologyService
    {
    }
}
