...
namespace Hl7.Fhir.Serialization
{
    public class FhirXmlException : CodedException
    {
        ...
        internal static readonly FhirXmlException INCORRECT_ROOT_NAMESPACE = new(INCORRECT_ROOT_NAMESPACE_CODE, $"Root has missing or incorrect namespace. Namespace should be {XmlNs.FHIR}.");
        ...
        internal static readonly FhirXmlException INCORRECT_XHTML_NAMESPACE = new(INCORRECT_XHTML_NAMESPACE_CODE, $"Narrative has missing or incorrect namespace. Namespace should be {XmlNs.XHTML}");
        ...
        internal static readonly FhirXmlException UNEXPECTED_ELEMENT = new(UNEXPECTED_ELEMENT_CODE, "Element '{0}' is not in the correct order ");
        ...
        internal static readonly FhirXmlException ATTRIBUTE_HAS_EMPTY_VALUE = new(ATTRIBUTE_HAS_EMPTY_VALUE_CODE, "The attribute '{0}' in element '{1}' has an empty value, which is not allowed.");
